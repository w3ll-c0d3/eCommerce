...
function CadastroCliente() {
  ...
  const [cep,setCep] = useState("")
    ...
    const putCliente = () => {
      ecommerceAPI.put(`/clientes/${idCliente}`, {
        "email": email,
  ...
  return (
    <Form>
      ...
      <Form.Group className="mb-3" controlId="formGridNome">
        ...
        <Form.Control type="number" value={idCliente} placeholder="Digite o id do cliente" onChange={(e) => setIdCliente(e.target.value)}/>
      </Form.Group>
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} controlId="formGridPassword">
          ...
          <Form.Control type="text" value={dataNascimento} placeholder="AAAA/MM/DD" onChange={(e) => setDataNascimento(e.target.value)} disabled />
        </Form.Group>
      </Row>

      <Form.Group className="mb-3" controlId="formGridCPF">
        <Form.Label>CPF</Form.Label>
        <Form.Control type="text" value={cpf} placeholder="CPF" onChange={(e) => setCpf(e.target.value)} disabled/>
      </Form.Group>
      {/* <Form.Group className="mb-3" controlId="formGridNome">
      ...
      <Button variant="primary" onClick={putCliente}>
        Atualizar
      </Button>
    </Form>
  );
